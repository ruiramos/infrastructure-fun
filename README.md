...
Around this time we also created config maps for the pods environment variables, with [kustomize helping us](https://kubectl.docs.kubernetes.io/guides/config_management/secrets_configmaps/) applying the right configuration for production and development environments.
